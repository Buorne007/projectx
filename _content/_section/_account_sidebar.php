...
<div id="sb_acc" class="sidebar-menu">
        <ul>
            <li><img src=<?php echo $avatar?> alt="Avatar" class="avatar center"></li>
            ...
            <li> <a href="#"  class="<?php if ($p == 'logout'){echo'active';}?>"><i class="fas fa-lightbulb fa-fw icone"></i>Logout</a> </li>
        </ul>
</div>
